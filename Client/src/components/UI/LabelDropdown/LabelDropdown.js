  ...
  render () {
    ...
    return (
      <div style={props.style}>
        <div>
          <ul>
            {this.props.labels.map(e => <li class='line'><Label onDeleteBoardLabel={this.props.onDeleteBoardLabel} isItem={ true } labelId={e['_id']} labelText={e['name']} backgroundColor={e['color']} /></li>)}
          </ul>
        </div>
        <div>
